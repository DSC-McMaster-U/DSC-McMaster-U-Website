...
import { blue, red, yellow, green } from "../asset/colors";
...
const Splash = ({ title, subTitle }) => (
  <div className="lg:container md:container sm:container">
    ...
    <div className="grid grid-cols-4">
      <div>
        <hr style={{ backgroundColor: blue[2], height: `2px` }} />
      </div>
      <div>
        <hr style={{ backgroundColor: red[2], height: `2px` }} />
      </div>
      <div>
        <hr style={{ backgroundColor: yellow[2], height: `2px` }} />
      </div>
      <div>
        <hr style={{ backgroundColor: green[2], height: `2px` }} />
      </div>
    </div>
  </div>
);
