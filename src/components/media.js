                    ...
                    <div className="w-auto md:w-2/3">
                        <div className="flex">
                            ...
                            <div className="w-auto lg:w-2/3">
                                <h1 className="text-5xl mb-1 text-center md:text-right lg:mr-12 sm:text-6xl">Follow Us </h1>                                      
                                <div className="inline-block">
                                    <p className="text-xl mb-5 text-gray-600 lg:text-2xl"> 
                                        <img className="inline-block mr-3 lg:ml-16" src={logo}></img> 
                            ...
                            <div className="w-0 lg:w-1/3">
                                <p className="hidden lg:block text-6xl mt-16 mr-20"><i class="far fa-comments"></i></p>
                            </div>
                        </div>
                        {/* Media Handles */}
                        <div className="flex ">
