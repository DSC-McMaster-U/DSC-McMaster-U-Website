...
const formUrl = 'https://script.google.com/macros/s/AKfycbxaAM3uyL_avJPMm4SsjXUVs-TqorvKLFohkKy2cP1J2hZ14ZQ3/exec'
...
export default class GForm extends Component {
  ...
  buttonToggle = (e) => {
    ...
    ? this.setState({ requirements_met: true }) : this.setState({ requirements_met: false })
  }

  onSubmit = (e) => {
      e.preventDefault()
           
      const { first_name, email, last_name, mac_id, program, academic_year,
              graduation, first_choice_team, second_choice_team, third_choice_team } = this.state

      const local_time = new Date()

      const date = local_time.getDate() + "/" + (Number(local_time.getMonth()) + 1) + "/" + local_time.getFullYear() +
      ...
      axios({
        ...
        `&First and Last Name=${encodeURIComponent(first_name + " " + last_name)}`  +
        ...
        `&Select your top 3 team preferences. [1st choice]=${encodeURIComponent(first_choice_team)}`   +
        `&Select your top 3 team preferences. [2nd choice]=${encodeURIComponent(second_choice_team)}`  +
        `&Select your top 3 team preferences. [3rd choice]=${encodeURIComponent(third_choice_team)}`  
        ...
        {this.state.submitted ? 
          ...
          <form className="form-color form-props" onSubmit={this.onSubmit}>
            <label className="big-label">
              ...
              <br></br>
              <input type="text" placeholder="Enter email" className="big-input" alt="Email"
                     onBlur={this.onChangeEmail} required/>                
            </label>
            
            <label className="small-label">
              First name<span className="red-asterisk"> *</span>
              <br></br>
              <input className="small-input" type="text" placeholder="First name" alt="First name"
                     onBlur={this.onChangeFirstName} required/>
            </label>           
            <label className="small-label">
              Last name<span className="red-asterisk"> *</span>
              <br></br>
              <input className="small-input" type="text" placeholder="Last name" alt="Last name"
                     onBlur={this.onChangeLastName} required/>
            </label>

            <label className="big-label">
              Mac ID<span className="red-asterisk"> *</span>
              <br></br>
              <input type="text" placeholder="e.g. muske7" className="big-input" alt="Mac ID"
                     onBlur={this.onChangeMacID} required/>                
            </label>

            <label className="extra-small-label">
              Program<span className="red-asterisk"> *</span>
              <br></br>
              <input className="extra-small-input" type="text" placeholder="e.g. Health Sci" alt="Program"
                     onBlur={this.onChangeProgram} required/>
            </label>

            <label className="extra-small-label" htmlFor="year">
              Academic year<span className="red-asterisk"> *</span>
              <br></br>
              <select className="extra-small-input" name="year" alt="Academic year"
                      onBlur={this.onChangeAcademicYear} required>
            ...
            <label className="extra-small-label">
              ...
              <br></br>
              <input className="extra-small-input" type="text" placeholder="Graduation year" 
                     alt="Expected graduation" onBlur={this.onChangeGraduation} required/>
            </label>
            ...
            <label className="extra-small-label" htmlFor="year">1st choice
              <br></br>
              <select className="extra-small-input" name="year" alt="1st choice"
            ...
            <label className="extra-small-label" htmlFor="year">2nd choice
              <br></br>
              <select className="extra-small-input" name="year" alt="2nd choice"
            ...
            <label className="extra-small-label" htmlFor="year">3rd choice
              <br></br>
              <select className="extra-small-input" name="year" alt="3rd choice"
            ...
            <button type="submit" value="Submit" className="submit" alt="Submit">
                Submit
              </button>
          </form>         
          }
